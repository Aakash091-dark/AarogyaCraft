...
//         strings: [
//             "<span class='simplify'>Simplify</span>",
//             "<span class='optimize'>Optimize</span>",
...
//         </h1>
//         <h2 className="head">
//           {/* Span with inline style to increase font size */}
//           <span ref={typedElement} style={{ fontSize: "4rem" }}></span> {/* Increase font size */}
//         </h2>
//         <p className="hero-description">
//           Discover innovative cloud-based management systems tailored for
//           various industries. Streamline your operations and enhance
//           productivity with our customizable and pre-built solutions.
//         </p>
//       </div>
